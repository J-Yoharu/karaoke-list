<template>
  <div id="app">
    <div class="container" style="min-height:100vh">
      ...
      <div class="row mt-5">
        <div class="col">
            <input class="form-control form-control-lg" style="border-radius:100px 100px 100px 100px" id="pesquisar" @keyup.enter="search" placeholder="Digite sua música ou cantor"/>
        </div>
      </div>
      <div class="row mt-4">
