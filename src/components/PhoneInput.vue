  ...
  <v-row dense>
    <v-col cols="4">
      ...
      >
        ...
        <template #selection> <country-flag :country="country.alpha2" /> </template>
      </v-select>
    </v-col>
    <v-col cols="8">
      <v-text-field
...
export default {
  ...
  setup(props, { emit }) {
    onMounted(() => {
      ...
      const alpha2 = language.includes('-') ? language.split('-')[1] : language
